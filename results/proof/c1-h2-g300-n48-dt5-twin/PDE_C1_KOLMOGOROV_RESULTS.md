...
- `epsilon_K` (signature radius): `0.0663752`
- `delta_H`: `0.0110992` (`0.05` x median high-mode norm, floor `1e-06`)
- high-mode norm median / min / max: `0.221985` / `0.214579` / `0.232894`
- signature-near sample coverage: `1` vs `S_pos = 0.5` (`50000` of `50000`)
- candidate pairs unique / directed: `1288081` / `2450000`
- witness sample fraction: `1` vs `0.01` (`50000` samples)
- witness pairs unique / directed: `918672` / `1711761` vs min unique `100`
- witness high-distance p50 / p95: `0.0172877` / `0.0292808`
- elapsed seconds: `6984.977`

## Paired fiber-constancy

**Paired verdict:** `PAIRED_FIBER_CONSTANCY_POSITIVE`

- witness-pair action disagreement (unique): `0.0384512` (`35324` of `918672`) vs `delta_action = 0.1`
- witness-pair action disagreement (directed): `0.0365524`
- candidate-pair action disagreement (unique, comparator): `0.02937` (`37831` of `1288081`)
