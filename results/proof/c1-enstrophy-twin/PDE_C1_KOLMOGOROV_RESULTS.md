...
- `epsilon_K` (signature radius): `0.0754549`
...
- elapsed seconds: `2442.361`

## Paired fiber-constancy

**Paired verdict:** `PAIRED_FIBER_CONSTANCY_POSITIVE`

- witness-pair action disagreement (unique): `0.0349642` (`24258` of `693795`) vs `delta_action = 0.1`
- witness-pair action disagreement (directed): `0.0341043`
- candidate-pair action disagreement (unique, comparator): `0.0315251` (`39820` of `1263121`)
