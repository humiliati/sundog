...
const projects = [
  ...
  },
  {
    ...
    currentRead:
      "Four pre-registered probes (3 signature vocabs x 2 target classes) on SU(2) 3D 12^3 all landed YM-P2-NEG-A; bounded-null synthesis filed.",
    blocker:
      "External lattice-gauge-theorist sanity check before any public claim beyond bounded-null discipline.",
    nextAction:
      "Send the external-review email, record the response; any reopened probe requires fresh external scientific motivation and a new dated preregistration.",
    publicBoundary:
      "No Yang-Mills existence, mass-gap, confinement, continuum-limit, or Clay-problem claim is licensed.",
    chartHeadline: "4 probes, 1 bounded null",
    pageHeadline:
      "Four pre-registered probes, one bounded cell-local null on SU(2) 3D 12^3 - lattice-gauge review packet drafted.",
    metrics: [
      { label: "phase 2 probes", value: 4, unit: "probes" },
      { label: "bounded nulls", value: 1, unit: "synthesis" },
    ...
    sources: [
      ...
      "docs/prereg/yang-mills/P0_AMENDMENT_2026-05-29_ape_smearing.md",
      "docs/yang-mills/receipts/2026-05-29_SU2_3D_phase2_bounded_null_synthesis.md",
      "docs/yang-mills/EXTERNAL_REVIEW_PACKET.md",
      "docs/yang-mills/EXTERNAL_REVIEW_EMAIL_DRAFT.md",
    ],
    svgFocus: ["status-card", "review-gate", "bounded-null-count"],
  },
  {
    id: "arc_agi",
    slug: "arc-agi",
