...
const projects = [
  ...
  },
  {
    ...
    currentRead:
      "Roadmap drafted only; no lit-pass, preregistration, runner, or result exists.",
    blocker:
      "Phase 0 must lock the finite-lattice domain, observables, source library, controls, and claim boundary before code.",
    nextAction:
      "Draft the lit-pass and P0 domain lock; keep the gallery card in draft-handoff posture until Phase 0 is filed.",
    publicBoundary:
      "No Yang-Mills existence, mass-gap, confinement, continuum-limit, or Clay-problem claim is licensed.",
    chartHeadline: "finite-lattice certificate draft",
    metrics: [
      { label: "live receipts", value: 0, unit: "receipts" },
      { label: "phase 0 files", value: 0, unit: "filed" },
      { label: "claimed Clay progress", value: 0, unit: "claims" },
    ],
    sources: ["docs/SUNDOG_V_YANG_MILLS.md"],
    svgFocus: ["status-card", "draft-handoff", "claim-boundary"],
  },
  {
    id: "arc_agi",
    slug: "arc-agi",
