...
const POLICIES = Object.freeze([
  ...
  },
  {
    ...
    family: "L-Mixed",
    label: "L-Mixed-M lambda=0.95 v4",
    tier: "Medium",
    lambda: 0.95,
    training_slug: "mixed_ppo_phase3_lambda_0_9_medium_seed_0_medium_phase5_v4_lambda_0_95_10m",
    phase3_dir: "phase5_v4_l_mixed_medium_lambda_0_95",
    phase4_dir: "phase5_v4_l_mixed_medium_lambda_0_95",
  },
  {
    axis: "A",
    policy_id: "mixed_lambda_0_97_medium_v4",
    family: "L-Mixed",
    label: "L-Mixed-M lambda=0.97 v4",
    tier: "Medium",
    lambda: 0.97,
    training_slug: "mixed_ppo_phase3_lambda_0_9_medium_seed_0_medium_phase5_v4_lambda_0_97_10m",
    phase3_dir: "phase5_v4_l_mixed_medium_lambda_0_97",
    phase4_dir: "phase5_v4_l_mixed_medium_lambda_0_97",
  },
  {
    axis: "A",
    ...
    tier: "Medium",
    lambda: 0.99,
    training_slug: "mixed_ppo_phase3_lambda_0_9_medium_seed_0_medium_phase5_v4_lambda_0_99_10m",
    phase3_dir: "phase5_v4_l_mixed_medium_lambda_0_99",
    phase4_dir: "phase5_v4_l_mixed_medium_lambda_0_99",
  },
  {
    axis: "A",
...
async function main() {
  ...
  await writeFile(path.join(outputRoot, "reports", "breach-threshold.json"), `${JSON.stringify({
    ...
    note: "Medium cliff is localized between lambda=0.95 and lambda=0.97; pure L-Reward lambda=1.0 remains the collapsed anchor.",
  }, null, 2)}\n`, "utf8");
