...
| `/isotrophy` | A | ✓ | isotrophy.png | TechArticle | ✓ | ✓ | sitemap + homepage pillar | ✓ | filed 2026-05-22 with full Class A treatment; broadened 2026-05-25 from the v0.3h public companion to the v0.3-v0.9 isotrophy audit-chain pause page, then refreshed 2026-05-30 for the v0.10/v0.11 conditional-rank profile. Viz remains the v0.3h 21-cell catalog grid (20 gold structural-zero receipts + 1 dashed-red quarantine for O_617), which is still the first load-bearing pillar. Current copy carries the v0.7 velocity-fraction positive, v0.10b mass-marginal held-out null, and v0.11 within-m3 conditional-rank pass. Sister ledger at [`SUNDOG_V_ISOTROPHY_KFACET.md`](../isotrophy/SUNDOG_V_ISOTROPHY_KFACET.md). |
