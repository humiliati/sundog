...
| (next)     | v0.3 is empirically closed as a structural-null mechanism. The remaining load-bearing theorem-facing work is the paper-side typed transport / induced-representation lemma; cross-`m3`, supplementary-B clustering refinements, and O_617 perturbation tests are robustness extensions rather than blockers for the v0.3 verdict. |
