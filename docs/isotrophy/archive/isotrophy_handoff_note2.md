...
**Two caveats**:
1. Raw CSV receipts gitignored/protected. Canonical per-row data lives in `docs/isotrophy/sundog_v_isotrophy.md` table (lines ~624-646). Reproduce via `npm run isotrophy:tau12:cases`.
...
4. Done: landed the receipt summary in `docs/isotrophy/sundog_v_isotrophy.md` and the canonical handoff note.
...
*This file created/updated in artifacts/ as durable record. In live repo, merge equivalent content into the canonical docs and docs/isotrophy/archive/isotrophy_handoff_note.md.*
