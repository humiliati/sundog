...
real-analysis shadow decay, halo minimum-deviation geometry, an Aharonov-Bohm gauge-invariance core
(vector calculus), and the general characteristic-function law behind the shadow decay as method examples,
not P-vs-NP evidence.
