...
This section is intentionally blank until the persona dispatch runs. Only
findings that survive consolidator verification go here.
...
Persona outputs that do not survive verification go here rather than into the
action plan.

| claim | persona | why dropped |
| --- | --- | --- |
