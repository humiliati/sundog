...
"upper-tangent opening angle"?~~ **Answered internally by Pass C7
(2026-05-14):** opening angle / arc extent (Tape 1994 Ch 6) is the
canonical handle. Pass C7 reformulated the test under that handle
against HaloSim ray-tracing ground truth and found C5's circle fit
geometrically inconsistent with the canonical arc curve (C5 places
wings 1.2-5.6° too-far-radially, progressively with azimuth). Route
remains unpromoted under both handles. Full receipt at
[`PASS_C7_OUTPUT.txt`](PASS_C7_OUTPUT.txt). Specialist could still
independently re-anchor p2 to the canonical curve as a third-party
check, but the route verdict no longer hinges on this.
