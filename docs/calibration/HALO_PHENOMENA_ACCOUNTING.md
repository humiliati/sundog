...
Status: 14A landed · 14D source pass landed (this revision) · 14F partially routed
...
5. **14E — HaloSim receipt pass:** still pending — capture at least one
   render per `halosim-candidate` row, or mark it not reproducible under
   the local library.
