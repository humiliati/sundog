# Shadow Faraday Documents

Canonical documents for the Shadow Faraday Zero-Out line live here.

- [Roadmap](SUNDOG_V_FARADAY.md): narrative phase plan and progress notes.
- [Ledger](SHADOW_FARADAY.md): receipt surface for phases, branches, and claim boundaries.
- [Phase 3 derivations](FARADAY_PHASE3_DERIVATIONS.md): Branch A algebraic zero receipt.
