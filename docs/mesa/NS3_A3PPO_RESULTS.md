...
Generated 2026-07-02T04:27:03.987Z by `scripts/mesa-ns3-a3ppo-aggregate.mjs`. Spec: [`NS3_A3PPO_THRESHOLD_VS_GRADED_SPEC.md`](NS3_A3PPO_THRESHOLD_VS_GRADED_SPEC.md).
...
| over_tau_mass | 0.75 | 0 |
| median in-band \|a\| | 0.936906 | 0.178463 |
| signal_rate (own regime) | 1 | 0 |
| competence (no-band) | 0 | 0 |
| fragility (perturbed - clean review) | 0 | 0.013889 |

sanity (both competent): **false**; P1 threshold bunches just under tau: **false**; P3 threshold fragile: **false**; corroborating {"graded_median_ge_thresh":false,"graded_over_tau_gt_thresh":false}; diagnostics {thresh_limp:false, grading_too_weak:true}.
