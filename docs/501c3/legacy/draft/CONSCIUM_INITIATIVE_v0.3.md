...
**Supersedes:** v0.2 (preserved at `CONSCIUM_INITIATIVE_v0.2.md`).
**Date:** 2026-05-22
...
- **Multi-Agent Review Record referenced** as a public-comment
  input appendix (see `CONSCIUM_MULTI_AGENT_REVIEW_RECORD_v0.1.md`).
...
`CONSCIUM_MULTI_AGENT_REVIEW_RECORD_v0.1.md`). The record is a
...
- Whether §1.1 (Evaluator obligations) is sufficient to close the
  ...
  (working title: *Conscium Considerations for Evaluated Systems*)
