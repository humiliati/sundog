...
contract filed; decoder training held. Phase 2 baseline comparison sharpened
the problem:
...
stricter ablation. The next Phase 3 work is to freeze learner choice,
thresholds, seeds, receipt paths, and public-language updates before any runner
executes.
