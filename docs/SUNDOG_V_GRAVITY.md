...
| **P1 — Falsifier admission review** | [`prereg/structural-failure-coincidence/P1_ADMISSION_REVIEW.md`](prereg/structural-failure-coincidence/P1_ADMISSION_REVIEW.md): independent pass over the frozen boundary map verifying every locus carries all five fields and a real receipt; reconcile any coded-guard vs literature-value vs prereg-stated discrepancies in writing. | Maps to prereg Outcome Branching row *"Cannot write the boundary map → halt; publish no agent claim."* P2 stays locked until P1 passes. | **complete — 2026-05-15** |
| **P2 — Agent run, four quantities scored separately** | [`prereg/structural-failure-coincidence/P2_AGENT_RUN.md`](prereg/structural-failure-coincidence/P2_AGENT_RUN.md): scores, as independent quantities: (1) convergence to withheld `h` — ≤ 0.027° on all three eligible photos; (2) counterfactual steerability — machine-precision zero at four synthetic targets; (3) failure-boundary coincidence — all five L1–L5 guards fire as documented; (4) matched-baseline efficiency — RMSE 0.02° vs. 22.53° for constant-mean baseline. | Admission Rule: 1–3 are the traceability claim; 4 is efficiency only. Failure on (2) or (3) ⇒ opaque-correlate, no traceability claim. Cannot start until P0+P1 cleared. | **complete — 2026-05-15** |
| **P3 — Outcome-branched disposition** | [`prereg/structural-failure-coincidence/P3_DISPOSITION.md`](prereg/structural-failure-coincidence/P3_DISPOSITION.md): P2 result maps to outcome branch **B** ("Agent converges, is steerable, and its failure boundary coincides with the closed-form identifiability boundary"). Public-Language Constraint applied. Stakeholder-safe benchmark / apparatus claim warranted; theorem posture avoided. | Public copy obeys the prereg's allow/avoid lists until structural-failure-coincidence has passed. | **complete — 2026-05-15** |
